const initialData = {
        "competition": [
            {
                "id": "457",
                "name": " Northern New South Wales Premier League",
                "is_league": "1",
                "is_cup": "0",
                "tier": "5",
                "has_groups": "0",
            ...
            {
                "id": "481",
                "name": "Copa De La Division Profesional",
                "is_league": "0",
                "is_cup": "1",
                "tier": "0",
                "has_groups": "0",
            ...
            {
                "id": "310",
                "name": "National Football League 2",
                "is_league": "1",
                "is_cup": "0",
                "tier": "3",
                "has_groups": "1",
            ...
            {
                "id": "469",
                "name": "New South Wales Premier League 2",
                "is_league": "1",
                "is_cup": "0",
                "tier": "3",
                "has_groups": "0",
...
const data = initialData.competition.map(i => (
    {
        id: i.id,
        country: i.countries && i.countries.length > 0 ? i.countries[0].name : "",
        flag: i.countries && i.countries.length > 0 ? i.countries[0].flag : "",
        country_id: i.countries && i.countries.length > 0 ? i.countries[0].id : "",
        tournament: i.name ? i.name : ''
    }
))
